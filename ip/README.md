...
route 可层层嵌套, 例如 10.0.0.0/24 和 10.0.1.0/24 可相互访问, 10.1.0.0/24 和 10.1.1.0/24 可互相访问, 将 10.0.0.254/8 和 10.1.0.254/8 连接在同一路由器的两端, 10.0.0.0/24 将 10.0.0.0/8 在路由表指向 10.0.0.254, 10.0.1.0/24 将 10.0.0.0/8 在路由表指向 10.0.1.1, 10.1.0.0/24 将 10.0.0.0/8 路由表指向 10.1.0.254, 10.1.1.0/24 将 10.0.0.0/8 路由表指向 10.1.1.1, 则设备均可相互访问 
