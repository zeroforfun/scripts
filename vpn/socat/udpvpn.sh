...
bash -c "/usr/bin/socat -T5 udp-listen:8443,fork tun,iff-up,tun-type=tap,tun-name=tap0 &" 0</dev/null 1>/dev/null 2>/dev/null
...
bash -c "/usr/bin/socat -T5 udp:SERVERIP:8443 tun,iff-up,tun-type=tap,tun-name=tap0 &" 0</dev/null 1>/dev/null 2>/dev/null
